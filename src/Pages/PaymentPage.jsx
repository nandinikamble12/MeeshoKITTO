        ...
        <Stack direction={{base:"column",md:"column",lg:"row"}} w={{base:"95%",md:"90%",lg:"60%"}} m="auto" mt="30px" >
          ...
          <FormLabel as="legend" fontWeight={600} mt="10px"   >
           Card Holder Name
            ...
            <Input type="text" placeholder="Ex:- Nandini kamble"  border="1px solid teal" name="cardHolderName" value={values.cardHolderName} onChange={handleChange}/><FormLabel as="legend" fontWeight={600} mt="10px"   >
